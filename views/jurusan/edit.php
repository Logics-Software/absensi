    ...
    <div class="row">
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div class="card">
                ...
                <form method="POST" action="/jurusan/edit/<?= $jurusan['idjurusan'] ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="namajurusan" name="namajurusan" 
                                       value="<?= htmlspecialchars($jurusan['namajurusan']) ?>" 
                                       required placeholder="Masukkan nama jurusan" maxlength="100">
                            </div>
                        </div>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><?= icon('save', 'me-1 mb-1', 18) ?>Update Jurusan</button>
                    </div>
                </form>
            </div>
        </div>
