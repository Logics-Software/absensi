    ...
    <div class="row">
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div class="card">
                ...
                <form method="POST" action="/kelas/edit/<?= $kelas['idkelas'] ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="idtahunajaran" name="idtahunajaran" required>
                                    ...
                                    <?php foreach ($tahunAjaranList as $ta): ?>
                                        <option value="<?= $ta['id'] ?>" <?= ($kelas['idtahunajaran'] == $ta['id']) ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="kelas" name="kelas" required>
                                    ...
                                    <?php foreach ($kelasOptions as $opt): ?>
                                        <option value="<?= htmlspecialchars($opt) ?>" <?= ($kelas['kelas'] == $opt) ? 'selected' : '' ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="idjurusan" name="idjurusan">
                                    ...
                                    <?php foreach ($jurusanList as $jurusan): ?>
                                        ...
                                        <option value="<?= $jurusan['idjurusan'] ?>" <?= ($kelas['idjurusan'] == $jurusan['idjurusan']) ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="namakelas" name="namakelas" 
                                       value="<?= htmlspecialchars($kelas['namakelas']) ?>" 
                                       required placeholder="Contoh: VII-A, X IPA 1" maxlength="100">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="idguru" name="idguru">
                                    ...
                                    <?php foreach ($guruList as $guru): ?>
                                        <option value="<?= $guru['id'] ?>" <?= ($kelas['idguru'] == $guru['id']) ? 'selected' : '' ?>>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary"><?= icon('save', 'me-1 mb-1', 18) ?>Update Kelas</button>
                    </div>
                </form>
            </div>
        </div>
