                        ...
                        <form method="GET" action="/wilayah/kabupaten" id="searchForm">
                            <div class="row g-2 align-items-end">
                                <div class="col-12 col-md-3">
                                    <select name="provinsi_id" class="form-select" id="filterProvinsi" onchange="document.getElementById('searchForm').submit()">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/wilayah/kabupaten/edit/<?= $item['id'] ?>" class="btn btn-sm btn-primary"><?= icon('pen-to-square', '', 14) ?> Edit</a>
                                        <a href="/wilayah/kabupaten/delete/<?= $item['id'] ?>" class="btn btn-sm btn-danger" onclick="event.preventDefault(); confirmDelete('Apakah Anda yakin ingin menghapus kabupaten/kota <?= htmlspecialchars($item['nama']) ?>?', this.href); return false;"><?= icon('trash-can', '', 14) ?> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                <?php endif; ?>
